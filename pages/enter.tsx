          ...
          <div className="grid border-b w-full mt-8 grid-cols-2 gap-16">
            <button
              className={cls(
                ...
                method === 'email'
                  ? 'font-medium  border-orange-400 text-orange-400'
          ...
          <div className="mt-1">
            ...
            {method === 'phone' ? (
              <div className="flex rounded-sm shadow-sm">
                ...
                <input
                  type="number"
                  className="py-2 px-4 border border-transparent appearance-none w-full border-gray-300 
                  rounded-l-none rounded-r shadow-sm placeholder-gray-400 
                  focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                  required
                />
              </div>
